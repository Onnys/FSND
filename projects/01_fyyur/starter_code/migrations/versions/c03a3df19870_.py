...
Revision ID: c03a3df19870
Revises: 11c5941a48c4
Create Date: 2020-05-01 15:54:58.383343
...
revision = 'c03a3df19870'
down_revision = '11c5941a48c4'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('Artist',
    sa.Column('id', sa.INTEGER(), server_default=sa.text('nextval(\'"Artist_id_seq"\'::regclass)'), nullable=False),
